...
Kun tarkasteellan saman sivun TCP ja UDP liikennettä, niin nähdään että laite 192.168.122.1 käyttää vain yhtä porttia 52 (UDP) kun taas 192.168.122.7 käyttää useampaa. Portti 53 on Domain Name System (DNS):lle eli vaikuttaisi, että se on DNS-palvelin tms ja toinen ehkä päätelaite, koska se käyttää useampia portteja ulospäin liikenteeseen. (https://en.wikipedia.org/wiki/List_of_TCP_and_UDP_port_numbers)
